...
vim.api.nvim_set_hl(0, 'AlphaHeader', { fg = gruvbox.yellow, bg = gruvbox.bg })
vim.api.nvim_set_hl(0, 'AlphaButtons', { fg = gruvbox.orange, bg = gruvbox.bg })
vim.api.nvim_set_hl(0, 'AlphaFooter', { fg = gruvbox.cyan, bg = gruvbox.bg })
